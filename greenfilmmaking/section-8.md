				...
				<ul>
					...
					<li>Green Toolbox <span class="text-center text-white-50 small">[Excerpt - visit the site!]</span>
						<ul>
							...
							<li>Catering <span class="text-center text-white-50 small">[German]</span>:
							...
							<li>Energy <span class="text-center text-white-50 small">[German]</span>:
							...
							<li>Light <span class="text-center text-white-50 small">[German]</span>:
							...
							<li>Set Design <span class="text-center text-white-50 small">[German]</span>:
